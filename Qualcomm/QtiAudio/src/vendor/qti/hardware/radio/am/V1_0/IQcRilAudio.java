...
public interface IQcRilAudio extends android.hidl.base.V1_0.IBase {
    ...
    public static final class Proxy implements IQcRilAudio {
        ...
        public void setCallback(IQcRilAudioCallback iQcRilAudioCallback)
            ...
            try {
                mRemote.transact(1 /* setCallback */, _hidl_request, _hidl_reply, 1);
        ...
        public void setError(int error)
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(2 /* setError */, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void setHALInstrumentation()
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(256462420 /* setHALInstrumentation */, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
        ...
        public void notifySyspropsChanged()
            ...
            android.os.HwParcel _hidl_reply = new android.os.HwParcel();
            try {
                mRemote.transact(257120595 /* notifySyspropsChanged */, _hidl_request, _hidl_reply, 1);
                _hidl_request.releaseTemporaryStorage();
            } finally {
                _hidl_reply.release();
            }
